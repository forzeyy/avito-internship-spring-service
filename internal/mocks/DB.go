...
func (_m *DB) Exec(ctx context.Context, query string, args ...interface{}) (pgconn.CommandTag, error) {
	var _ca []interface{}
...
//   - query string
//   - args ...interface{}
func (_e *DB_Expecter) Exec(ctx interface{}, query interface{}, args ...interface{}) *DB_Exec_Call {
	return &DB_Exec_Call{Call: _e.mock.On("Exec",
		append([]interface{}{ctx, query}, args...)...)}
}

func (_c *DB_Exec_Call) Run(run func(ctx context.Context, query string, args ...interface{})) *DB_Exec_Call {
